...
public class HomeFragmentContants {
    ...
    public static final List<HomeImageButton> homeImageButtonListMix = List.of(
            ...
            new HomeImageButton("Fête", R.color.party_color, R.drawable.outline_celebration_24),
            new HomeImageButton("Détente", R.color.cleaning_color, R.drawable.outline_spa_24),
            new HomeImageButton("Nuit", R.color.night_color, R.drawable.outline_bedtime_24),
            new HomeImageButton("Tristesse", R.color.sad_color, R.drawable.round_sentiment_dissatisfied_24),
            new HomeImageButton("Gaming", R.color.gaming_color, R.drawable.outline_sports_esports_24),
            new HomeImageButton("Matin", R.color.morning_color, R.drawable.outline_wb_sunny_24),
            new HomeImageButton("Ménage", R.color.wash_color, R.drawable.outline_cleaning_services_24),
            new HomeImageButton("Conduite", R.color.drive_color, R.drawable.outline_drive_eta_24),
            new HomeImageButton("Travail", R.color.work_color, R.drawable.outline_work_outline_24),
            new HomeImageButton("Réflexion", R.color.mind_color, R.drawable.outline_school_24)
    );
