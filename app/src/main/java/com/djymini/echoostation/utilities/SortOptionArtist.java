...
public enum SortOptionArtist {
    ...
    ARTIST_DESC("Artiste (Z-A)", Comparator.comparing((Artist ar) -> ar.name, String.CASE_INSENSITIVE_ORDER).reversed());

    private final String displayName;
    private final Comparator<Artist> comparator;

    SortOptionArtist(String displayName, Comparator<Artist> comparator) {
    ...
    public Comparator<Artist> getComparator() {
        return comparator;
    }
